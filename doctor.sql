...
CREATE TABLE `doctor` (
  ...
  `secretary_name` varchar(50) DEFAULT NULL,
...
INSERT INTO `doctor` VALUES (1,'neelufar','aasif'),(2,'neha','shekhar'),(3,'heba','sane'),(4,'shumaila','areeb');
...
-- Dump completed on 2020-08-10 10:32:17
